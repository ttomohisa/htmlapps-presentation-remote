...
const must = (cond,label)=>{ if(!cond) throw new Error(`Release v1.0.0 invariant failed: ${label}`); };
...
console.log('v1.0.0 release metadata / screenshots / privacy / offline invariants passed.');
