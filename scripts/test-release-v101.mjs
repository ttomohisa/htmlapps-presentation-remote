...
const must = (cond,label)=>{ if(!cond) throw new Error(`Release v1.0.1 invariant failed: ${label}`); };

must(app.version === '1.0.1','app.config version');
must(html.includes('id="versionBadge">v1.0.1'),'visible version badge');
...
must(spec.includes('- Version: `1.0.1`'),'APP_SPEC release target');
must(changelog.includes('## 1.0.1 - 2026-09-01'),'CHANGELOG 1.0.0 entry');
...
console.log('v1.0.1 release metadata / screenshots / privacy / offline invariants passed.');
